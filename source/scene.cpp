...
#ifndef MULTIBOOT
std::function<Scene*()> ModeListScene::previousScene() { return []{ return new MainMenuScene(); }; }
#else
std::function<Scene*()> ModeListScene::previousScene() { return []{ return new MultBattleScene(); }; }
#endif
