...
#elif defined(PC) || defined(ANDROID)
            u32 key = key_first();
...
#if defined(GBA) || defined(SWITCH) || defined(MM) || defined(PORTMASTER) || defined(PC) || defined(VITA)
...
public:
    ...
    std::function<Scene*()> previousScene() { return []{ return new ControlOptionScene(); }; };
};
#endif
